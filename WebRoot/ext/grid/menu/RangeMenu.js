...
Ext.extend(Ext.menu.RangeMenu, Ext.menu.Menu, {
	...
	updateBuffer: 500,
	icons: {
		gt: WWWROOT+'/ext/resources/images/default/grid/filter/greater_then.png', 
		lt: WWWROOT+'/ext/resources/images/default/grid/filter/less_then.png',
		eq: WWWROOT+'/ext/resources/images/default/grid/filter/equals.png'
  },
